...
using QTMusicStoreLight.Logic.Modules.Exceptions;
using QTMusicStoreLight.Logic.Modules.Security;
...
namespace QTMusicStoreLight.Logic.Modules.Account
{
                ...
                if (session != null && session.IsActive)
                {
                    ...
                    if (identity != null)
                    {
                        ...
                        session.JsonWebToken = JsonWebToken.GenerateToken(new Claim[]
                        {
                            ...
                            new Claim(ClaimTypes.System, nameof(QTMusicStoreLight)),
